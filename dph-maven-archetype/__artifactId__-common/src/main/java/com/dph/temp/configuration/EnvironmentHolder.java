...
public class EnvironmentHolder implements EnvironmentAware {
    ...
    private static class PropertiesBuilder {
        ...
        public static void build(Object target, String prefix) {
            ...
            PropertiesConfigurationFactory<Object> configurationFactory = new PropertiesConfigurationFactory<Object>(target);
            ...
            try {
                ...
                throw new RuntimeException(target.getClass().getSimpleName() + "配置对象初始化失败", e);
            }
        }
